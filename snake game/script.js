...
// Update the speed variable when the slider value changes
speedSlider.addEventListener("input", (e) => {
    speed = parseInt(e.target.value); // Update speed dynamically
    console.log("Speed changed to:", speed); // Optional: Log the new speed
});
